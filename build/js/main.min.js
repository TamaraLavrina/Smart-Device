...
window.addEventListener('DOMContentLoaded', function () {
  ...
  breakpointChecker();
  Object(imask__WEBPACK_IMPORTED_MODULE_4__["default"])(inputElement, maskOptions); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var userCheckbox = modal.querySelector('#agree');
var submitHandler = modal.querySelector('[type="submit"]');

var validateModalForm = function validateModalForm() {
  Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(modalInput, maskOptions);
  Object(_form__WEBPACK_IMPORTED_MODULE_0__["checkAgreement"])(userCheckbox, submitHandler);
};
