...
var accordeonToggle = function accordeonToggle(evt) {
  evt.preventDefault();
  var title = evt.target.closest('dt');
  title.classList.toggle('footer__title--active');
  var currentContent = title.nextElementSibling;
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: formValid, checkAgreement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var submitHandler = document.querySelector('[type="submit"]'); // const form = document.querySelector('.form__questions');
