...
/* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/accordeon */ "./js/modules/accordeon.js");
...
/* harmony import */ var _modules_modal_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modal-form.js */ "./js/modules/modal-form.js");
...
var inputElement = document.querySelector('[name="tel"]');
var maskOptions = {
...
var breakpointChecker = function breakpointChecker() {
  if (!breakpoint.matches) {
    ...
    Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["accordeonInit"])();
  }
};
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  breakpointChecker();
  Object(imask__WEBPACK_IMPORTED_MODULE_4__["default"])(inputElement, maskOptions);
  window.addEventListener('load', function () {
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["formValid"])();
    Object(_modules_modal_form_js__WEBPACK_IMPORTED_MODULE_5__["validateModalForm"])();
  });
...
var accordButtons = document.querySelectorAll('.footer__title');
var content = document.querySelectorAll('.footer-acc-text');
var headers = document.querySelectorAll('.footer__title');

var accordeonToggle = function accordeonToggle(evt) {
  var currentTitle = evt.target.closest('dt');
...
var accordeonInit = function accordeonInit() {
  if (!content) {
    ...
    accordButtons.forEach(function (item) {
...
var SERVER = 'https://echo.htmlacademy.ru';
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkAgreement", function() { return checkAgreement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showSuccessCard", function() { return showSuccessCard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showErrorCard", function() { return showErrorCard; });
/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetch */ "./js/modules/fetch.js");
...
var checkAgreement = function checkAgreement(userCheckbox, button) {
...
var userCheckbox = document.querySelector('#agree');
var submitHandler = document.querySelector('[type="submit"]');
var form = document.querySelector('.form__questions');

var showErrorCard = function showErrorCard() {
...
var showSuccessCard = function showSuccessCard() {
  toastify_js__WEBPACK_IMPORTED_MODULE_1___default()({
...
var setUserFormSubmit = function setUserFormSubmit(onSuccess) {
  form.addEventListener('submit', function (evt) {
    evt.preventDefault();
    Object(_fetch__WEBPACK_IMPORTED_MODULE_0__["sendData"])(function () {
      onSuccess();
      form.reset();
    }, function () {
      showErrorCard();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateModalForm", function() { return validateModalForm; });
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ "../node_modules/imask/esm/index.js");
/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetch */ "./js/modules/fetch.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./form */ "./js/modules/form.js");



var modal = document.querySelector('.modal');
var modalInput = document.querySelector('[name="modal-tel"]');
var maskOptions = {
  mask: '+{7}(000)000-00-00'
};
var userCheckbox = document.querySelector('#modal-agree');
var modalSubmitHandler = document.querySelector('.modal__btn-submit');
var feedbackButton = document.querySelector('[data-open-modal]');
var modalForm = document.querySelector('.modal__questions');

var checkAgreement = function checkAgreement() {
  if (modal) {
    if (userCheckbox.checked === true) {
...
var setUserFormSubmit = function setUserFormSubmit(onSuccess) {
  modalForm.addEventListener('submit', function (evt) {
    evt.preventDefault();
    Object(_fetch__WEBPACK_IMPORTED_MODULE_1__["sendData"])(function () {
      onSuccess();
      modalForm.reset();
    }, function () {
      Object(_form__WEBPACK_IMPORTED_MODULE_2__["showErrorCard"])();
    }, new FormData(evt.target));
  });
};

var checkModal = function checkModal() {
  Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(modalInput, maskOptions);
  userCheckbox.addEventListener('change', checkAgreement);
};

var validateModalForm = function validateModalForm() {
  if (feedbackButton) {
    feedbackButton.addEventListener('click', checkModal);
    setUserFormSubmit(_form__WEBPACK_IMPORTED_MODULE_2__["showSuccessCard"], _form__WEBPACK_IMPORTED_MODULE_2__["showErrorCard"]);
  }
};
